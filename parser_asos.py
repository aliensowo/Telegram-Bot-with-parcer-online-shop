...
base_url = 'https://www.asos.com/ru/men/ctas/aktsiya-8/cat/?cid=28240&ctaref=shop|50offparty|mw_hp_50&page=1'


def asos_parse(base_url, headers):
    items = []
